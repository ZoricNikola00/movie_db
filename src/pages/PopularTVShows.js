...
const PopularTVShows = () => {
  ...
  const {data,isLoading,isError,error,refetch}=useQuery(['popular-tv'],()=>fetchData(`https://api.themoviedb.org/3/discover/tv?sort_by=popularity.desc&api_key=${env.process.TMDB_API_KEY}&page=${page}`),{onSuccess:()=>  window.scrollTo(0, 0)})
