...
const TopRatedTVShows = () => {
  ...
  const {data,isLoading,isError,error,refetch}=useQuery(['top-tv'],()=>fetchData(`https://api.themoviedb.org/3/tv/top_rated?api_key=${procces.env.TMDB_API_KEY}&language=en-US&page=${page}`),{onSuccess:()=>  window.scrollTo(0, 0)})
